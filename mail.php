...
$mail->addAddress('batinak94@gmail.com');               // Name is optional
$mail->isHTML(true);                                  // Set email format to HTML


if (!empty ($_POST['name']) && !empty ($_POST['email']) && !empty ($_POST['surname']) && !empty ($_POST['tel']) && !empty ($_POST['message'])) {
    ...
    $mail->Subject =$email;
    $mail->Body = 'Повідомлення від <strong>'.$name.' '.$surname.'</strong><br/>Номер телефону відправника <strong>'.$tel.' </strong><br/>' .$message;
